...
chi::TaskResume Runtime::Run(chi::u32 method, hipc::FullPtr<chi::Task> task_ptr, chi::RunContext& rctx) {
  switch (method) {
    case Method::kCreate: {
      co_await Create(task_ptr.Cast<CreateTask>(), rctx);
      break;
    }
    ...
    case Method::kRegisterTarget: {
      co_await RegisterTarget(task_ptr.Cast<RegisterTargetTask>(), rctx);
      break;
    }
    ...
    case Method::kPutBlob: {
      co_await PutBlob(task_ptr.Cast<PutBlobTask>(), rctx);
      break;
    }
    case Method::kGetBlob: {
      co_await GetBlob(task_ptr.Cast<GetBlobTask>(), rctx);
      break;
    }
    case Method::kReorganizeBlob: {
      co_await ReorganizeBlob(task_ptr.Cast<ReorganizeBlobTask>(), rctx);
      break;
    }
    case Method::kDelBlob: {
      co_await DelBlob(task_ptr.Cast<DelBlobTask>(), rctx);
      break;
    }
    case Method::kDelTag: {
      co_await DelTag(task_ptr.Cast<DelTagTask>(), rctx);
      break;
    }
